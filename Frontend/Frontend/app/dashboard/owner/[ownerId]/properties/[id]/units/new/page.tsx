...
const handleSubmit = async (e: React.FormEvent) => {
  ...
  try {
    ...
    // 👉 Get the token (adjust depending on where you store it)
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            <Button variant="outline" size="sm" asChild>
              <Link href={`/dashboard/owner/${id}/properties/${id}`}>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>መሰረታዊ የክፍል መረጃ / Basic unit information</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2"> 
  <Label htmlFor="deposit">የዋስትና ገንዘብ / Security Deposit (ETB)</Label>
  <Input
    id="deposit"
    type="number"
    value={formData.deposit || 60000}
  ...
  />
          ...
          <div className="flex justify-end space-x-4">
            <Button variant="outline" type="button" asChild>
              <Link href={`/dashboard/owner/${id}/properties/${id}`}>ተወው / Cancel</Link>
            </Button>
            <Button
              type="submit"
