...
useEffect(() => {
  ...
  const fetchNotifications = async () => {
    setLoading(true);
    try {
      console.log("Calling endpoint:", `http://localhost:5000/owner/${ownerId}/notifications/maintenance`);
      const res = await axios.get<Notification[]>(`http://localhost:5000/owner/${ownerId}/notifications/maintenance`);
