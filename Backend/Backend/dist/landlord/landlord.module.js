...
const LandlordController_1 = require("./LandlordController");
...
exports.LandlordModule = LandlordModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([landlord_entity_1.Landlord])],
        providers: [landlord_service_1.LandlordService],
        controllers: [LandlordController_1.LandlordController],
